        ...
        <form onSubmit={handleSubmit} className="p-5 space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <input className="form-input text-sm" value={form.ruknId} onChange={e => set('ruknId', e.target.value)} inputMode="numeric" required />
            </div>
            <div>
            ...
            <div>
              ...
              <select className="form-select text-sm" value={form.gender} onChange={e => set('gender', e.target.value)} required>
