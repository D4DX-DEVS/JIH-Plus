      ...
      >
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center justify-between h-16 px-4 border-b border-gray-200 bg-gradient-to-r from-[#002349] to-[#1a3a5c]">
            <div className="flex items-center space-x-3 min-w-0">
              ...
              <div className={isDesktopCollapsed ? 'lg:hidden' : ''}>
                <h2 className="text-base font-bold text-white" style={{ fontFamily: 'Cinzel, serif' }}>
                  JIH Plus
                </h2>
              </div>
            </div>
          ...
          <div className={`px-4 py-3 border-b border-gray-200 bg-gray-50 ${isDesktopCollapsed ? 'lg:hidden' : ''}`}>
            ...
            <p className="text-sm text-[#002349] font-semibold truncate uppercase">{districtName}</p>
          </div>
                  ...
                  return (
                    <div key={item.id}>
                      ...
                      >
                        ...
                        <ChevronDown className={`w-4 h-4 transition-transform duration-200 ${isOpen ? 'rotate-180' : ''} ${isGroupActive ? 'text-white' : 'text-gray-400'} ${isDesktopCollapsed ? 'lg:hidden' : ''}`} />
                      </button>
                          ...
                          {(item.children || []).map(child => {
                            ...
                            return (
                              <button
                                ...
                                className={`w-full flex items-center justify-between pl-4 pr-3 py-2 text-xs font-medium rounded-lg transition-colors ${
